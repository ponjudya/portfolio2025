...
const ProjectCard = ({ project, index, isDarkMode }) => {
    ...
    >
        ...
        >
            ...
            <div className="relative overflow-hidden">
                ...
                >
                    <motion.a
                        ...
                        className="bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-full flex items-center space-x-2 text-sm font-medium transition-colors"
                    >
            ...
            {/* Project Content */}
            <div className="p-6">
                <h3 className="text-xl font-medium mb-3 group-hover:text-teal-500 transition-colors">
                    {project.title}
                </h3>
