            ...
            {/* Mobile Layout Centered */}
                    <div className="block lg:hidden">
                        ...
                        >
                            ...
                            >
                                Bringing designs to life and exploring code by creating simple, user-friendly interfaces.
                            </motion.p>
                            ...
                            >
                                <motion.button
                                    ...
                                    className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-3 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300 cursor-pointer"
                                >
                                    Discover
                                </motion.button>
                            ...
                            >
                                {[
                                    { icon: FiLinkedin, href: "https://www.linkedin.com/in/judypontiveros"},
                                    { icon: FaBehance, href: "https://www.behance.net/japnti" },
                                    { icon: RiGithubLine, href: "https://github.com/ponjudya" },
                                    { icon: Mail, href: "mailto:judy.pontiveros@gmail.com" },
                                ].map((social, index) => (
                    ...
                    <div className="hidden lg:grid lg:grid-cols-2 lg:gap-10 lg:items-center">
                        ...
                        >
                            ...
                            <motion.h1 
                                variants={itemVariants}
                                className="text-5xl xl:text-[69px] font-light mb-8 leading-tight"
                            >
                                <span
                                ...
                                <span className="text-teal-500 font-medium"> care</span>
                                <br/>
                                
                                <span className={isDarkMode ? "text-white" : "text-gray-900"}>
                                    Designing with
                                </span>
                                <span className="text-teal-500 font-medium"> heart</span>
                            </motion.h1>
                            ...
                            <motion.div variants={itemVariants} className="flex gap-6 mb-8">
                                <motion.button 
                                    ...
                                    whileTap={{ scale: 0.98 }}
                                    onClick={() => scrollToSection("skills")}
                                    className="bg-teal-500 hover:bg-teal-600 text-white px-8 py-4 rounded-full text-sm uppercase tracking-wider font-medium transition-all duration-300 cursor-pointer"
                                >
                                    Discover
                                </motion.button>
                        ...
                        >
                            <div className="relative">
                                ...
                                <motion.div
                                    variants={itemVariants}
                                    className="flex items-center space-x-6 text-xs uppercase tracking-widest absolute -top-16 -left-28"
                                >
                                    <span
                                        className={isDarkMode ? "text-gray-600" : "text-gray-500"}
                                    >
